...
class TestQuad(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        self.Q_d5_o5_LG_sp = pypce.QuadGen(dim=5,order=5,rule='legendre_gauss',sparse=True)
        self.xw_d5_o5_LG_sp = self.Q_d5_o5_LG_sp.run()
        self.Q_d5_o5_LG_tp = pypce.QuadGen(dim=5,order=5,rule='legendre_gauss',sparse=False)
        self.xw_d5_o5_LG_tp = self.Q_d5_o5_LG_tp.run()

        self.Q_d10_o2_LG_sp = pypce.QuadGen(dim=10,order=2,rule='legendre_gauss',sparse=True)
        self.xw_d10_o2_LG_sp = self.Q_d10_o2_LG_sp.run()
        self.Q_d10_o2_LG_tp = pypce.QuadGen(dim=10,order=2,rule='legendre_gauss',sparse=False)
        self.xw_d10_o2_LG_tp = self.Q_d10_o2_LG_tp.run()

        self.Q_d5_o5_CC_sp = pypce.QuadGen(dim=5,order=5,rule='clenshaw_curtis',sparse=True)
        self.xw_d5_o5_CC_sp = self.Q_d5_o5_CC_sp.run()
        self.Q_d5_o5_CC_tp = pypce.QuadGen(dim=5,order=5,rule='clenshaw_curtis',sparse=False)
        self.xw_d5_o5_CC_tp = self.Q_d5_o5_CC_sp.run()

        self.Q_d10_o2_CC_sp = pypce.QuadGen(dim=10,order=2,rule='clenshaw_curtis',sparse=True)
        self.xw_d10_o2_CC_sp = self.Q_d10_o2_CC_sp.run()
        self.Q_d10_o2_CC_tp = pypce.QuadGen(dim=10,order=2,rule='clenshaw_curtis',sparse=False)
        self.xw_d10_o2_CC_tp = self.Q_d10_o2_CC_tp.run()

    def test_sparse_quadrature_dim5_order5_LegGauss(self): 
        # test...
        dim = 5
        # Q = pypce.QuadGen(dim=dim,order=5,rule='legendre_gauss',sparse=True)
    ...
    def test_tensor_prod_quadrature_dim5_order5_LegGauss(self):
        # test...
        dim = 5
        # Q = pypce.QuadGen(dim=dim,order=5,rule='legendre_gauss',sparse=False)
    ...
    def test_sparse_quadrature_dim5_order5_clenshaw_curtis(self):
        # test...
        dim = 5
        # Q = pypce.QuadGen(dim=dim,order=5,rule='clenshaw_curtis',sparse=True)
    ...
    def test_sparse_vs_tensor_product_size_d10(self):
        # test...
        dim = 10
        # Q_sp = pypce.QuadGen(dim=dim,order=2,rule='legendre_gauss',sparse=True)
        x_sp,w_sp = self.xw_d10_o2_LG_sp

        # Q_tp = pypce.QuadGen(dim=dim,order=2,rule='legendre_gauss',sparse=False)
    ...
    def test_sparse_and_tensor_grid_x_and_w_size_match_CC(self):
        # test...
        dim = 5
        # Q_sp = pypce.QuadGen(dim=dim,order=5,rule='clenshaw_curtis',sparse=True)
        x_sp,w_sp = self.xw_d5_o5_CC_sp

        # Q_tp = pypce.QuadGen(dim=dim,order=5,rule='clenshaw_curtis',sparse=False)
    ...
    def test_sparse_and_tensor_weight_norm_check_to_1_d5_LG(self):
        # test...
        dim = 5
        # Q_sp = pypce.QuadGen(dim=dim,order=5,rule='legendre_gauss',sparse=True)
        x_sp,w_sp = self.xw_d5_o5_LG_sp

        # Q_tp = pypce.QuadGen(dim=dim,order=5,rule='legendre_gauss',sparse=False)
