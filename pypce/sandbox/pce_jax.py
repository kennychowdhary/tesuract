...
Kmax = jnp.amax(mindex,axis=0) # max order per dimension
...
c0 = np.zeros(3)
optopt = {'gtol': 1e-8, 'disp': True}
# res = scipy.optimize.minimize(fun, c0, 
#             jac=gfun, method='BFGS', options=optopt)
