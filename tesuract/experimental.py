...
def minimize_call(xstart,objfunc,bounds,factr,disp=5):
	...
	'''
	res = fmin_l_bfgs_b(objfunc,xstart,approx_grad=True,bounds=bounds,factr=factr,pgtol=1e-10,disp=disp)
	return res
...
class GPReg:
	...
	def fit2(self,X,y):
		...
		xstarts = random_sample_within_bounds(nsolves,start_bounds,rn=self.random_state)
